    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="http://gohousin.com/app/information%20sharing/index.php/information-sharing/" class="nav-link">Information Sharing</a></li>
    ...
    if ($nameRow != 0) {
        ...
        { $diff=0;
            ...
            if(abs($nameRow['sroommatealcoholuse']-$one['roommatealcoholuse'])>=2)
                continue;
            if(abs($nameRow['smoke']-$one['smoke'])>1)
                continue;
            if(abs($nameRow['roommatesmoke']-$one['roommatesmoke'])>1)
                continue;
            ...
            for($j=0;$j<3;$j++)
            {
                ...
                print($matchresf[$i]." ".$matchresl[$i]);
                    ...
                    <div class=\"text\">
                        <blockquote>
                            <p>");
                print($matchress[$i]." is his/her school" . "\n contact him/her through email ".$matchrese[$i]  );
                    print("</p>
                        </blockquote>
                    </div>
                </div>
