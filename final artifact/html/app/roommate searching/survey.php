...
?>
        ...
        <div class="wrap-contact100">
            <form form class="contact100-form validate-form" action = "survey.php" method = "POST">
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="howclean" value="1"> Clean right away<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="time" value="1"> A majority of the time<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="alcohol" value="1"> Never<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="roomalcohol" value="1">  Prefer no alcohol<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="smoke" value="1">  Yes<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="roomsmoke" value="1">  Yes<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="guest" value="1"> Never<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="roomguest" value="1">  Prefer no guests<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="day" value="1">  In the morning<br>
                ...
                <div class="wrap-input100 input100-select bg1">
                    ...
                    <div class = "radio">
                        <input type="radio" name="night" value="1">  Before 10pm<br>
        ...
        if($_POST['give']) {
            ...
            $mysqli->close();
            header("Location: http://www.gohousin.com/app/roommate%20searching/roommate%20searching.php");    
        }
